...
const service_data: DataType[] = [
  {
    ...
    desc: "Transform your mindset, eliminate mental roadblocks, and achieve success in life and work with personalized growth coaching.",
  },
  {
    id: 2,
    page: "home_1",
    ...
    desc: "Identify and overcome self-doubt, fear, and limiting beliefs to develop a positive, growth-oriented mindset.",
  },
  {
    id: 3,
    page: "home_1",
    ...
    desc: "Enhance self-confidence, develop leadership skills, and learn to balance personal and professional growth.",
  },
  {
    id: 4,
    page: "home_1",
    data_wow_delay: "0.3s",
    icon: service_Icon4,
    title: " Create a Fulfilling Life",
    desc: "Set actionable goals, improve emotional intelligence, and foster a positive mindset for long-term success and happiness.",
  },
  //   {
  //     id: 5,
  //     page: "home_1",
